...
- `GET /api/agents/releases/automation-runs`
...
- `POST /api/providers/policy-gate/run`
- `GET /api/providers/policy-gate/runs`
...
- `POST /api/usage/finance-operations/run`
