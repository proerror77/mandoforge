...
- Latest remote archive: `/opt/mandoforge-adoption/archives/mandoforge-whiskey-pilot-20260517T221130Z.tar.gz`.
- Latest local archive copy: `.mandoforge/remote-adoption/whiskey/mandoforge-whiskey-pilot-20260517T221130Z.tar.gz`.
- Latest Stage 2 strict archive copy: `.mandoforge/remote-adoption/whiskey/stage2-production-whiskey-20260517T221130Z.tar.gz`.
...
The latest consolidated host inventory on 2026-05-17T22:09:45Z returned `preflight_status=constrained_pilot_only` and `verify_status=not_installed` with:

- `cpu_count=2`
- `mem_available_mib=1616`
- `swap_used_mib=1386`
- `root_avail_gib=83.3`
- `cgroup_fs=cgroup2fs`
- `reserved_ports=none`
