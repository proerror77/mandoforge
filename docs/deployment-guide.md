...
assignment routing, review, Activity Feed, and Manager Plan binding evidence,
and verifies the Codex adapter shim. It is the main local completion check for
the runtime kernel and first Collaboration Layer intake/routing/review/activity
plus planning slice.
