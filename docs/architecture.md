...
- Policy Center supports active YAML policy inspection, single-tool simulation, batch policy testing, and audit logging for policy simulation/test actions; production policy editing and rollout remain reserved.
