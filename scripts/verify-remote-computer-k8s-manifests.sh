...
if ! grep -q 'image: ghcr.io/proerror77/mandoforge/mandoforge-agent-sandbox-runtime@sha256:544137e95674ebc5ce2c4b25d0bb1c01c18cd11e7a296d0d1db872a8daded5bf' "$agent_sandbox_template_render" \
