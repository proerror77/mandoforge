...
require_pattern README.zh-CN.md "runtime-centered Enterprise Agent OS"
require_pattern README.zh-CN.md "Manager Runtime 和 Managed Runtime"
require_pattern README.zh-CN.md "Environment Scheduling Layer"
require_pattern README.zh-CN.md "Ontology Action Contract Layer"
require_pattern README.zh-CN.md "K Agent"
...
require_absent README.zh-CN.md "Work Surfaces -> Collaboration -> Manager Agent / Work Coordination -> Managed Runtime -> Semantic Layer -> Data Foundation"
require_absent README.zh-CN.md "Managed Runtime -> Semantic Layer -> Data Foundation"
require_absent README.zh-CN.md "Enterprise Data Foundation"
require_absent README.zh-CN.md "Semantic Layer / Ontology Service"
require_absent README.zh-CN.md "Semantic Layer 是下一步产品化重点"
require_absent README.zh-CN.md "Agent / Semantic Layer 都依赖"
