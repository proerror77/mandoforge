...
if ! grep -q "state_sync_checked_path_count" "$remote_computer_script" || ! grep -q "state_sync_checked_path_detail_count" "$remote_computer_script" || ! grep -q "state_sync_state_claim" "$remote_computer_script"; then
...
if ! grep -q "routing_cross_tenant_negative_test_count" "$tenant_script" || ! grep -q "routing_cross_tenant_negative_test_detail_count" "$tenant_script"; then
...
if ! grep -q "tenant_sample_count" scripts/stage2-completion-audit-gate.sh || ! grep -q "tenant_sample_detail_count" scripts/stage2-completion-audit-gate.sh || ! grep -q "rls_forced_table_count" scripts/stage2-completion-audit-gate.sh || ! grep -q "forced_rls_table_detail_count" scripts/stage2-completion-audit-gate.sh || ! grep -q "cross_tenant_negative_test_detail_count" scripts/stage2-completion-audit-gate.sh; then
...
if ! grep -q "load_validated" scripts/verify-stage2-evidence-archive.sh || ! grep -q "load_check_detail_count" scripts/verify-stage2-evidence-archive.sh || ! grep -q "checked_path_detail_count" scripts/verify-stage2-evidence-archive.sh || ! grep -q "checked_pod_detail_count" scripts/verify-stage2-evidence-archive.sh; then
...
if ! grep -q "load_validated" scripts/stage2-completion-audit-gate.sh || ! grep -q "load_check_detail_count" scripts/stage2-completion-audit-gate.sh || ! grep -q "checked_path_detail_count" scripts/stage2-completion-audit-gate.sh || ! grep -q "checked_pod_detail_count" scripts/stage2-completion-audit-gate.sh; then
...
if ! grep -q "tenant_sample_count" scripts/verify-stage2-evidence-archive.sh || ! grep -q "tenant_sample_detail_count" scripts/verify-stage2-evidence-archive.sh || ! grep -q "rls_forced_table_count" scripts/verify-stage2-evidence-archive.sh || ! grep -q "forced_rls_table_detail_count" scripts/verify-stage2-evidence-archive.sh || ! grep -q "cross_tenant_negative_test_detail_count" scripts/verify-stage2-evidence-archive.sh; then
