...
#[derive(Debug, Deserialize)]
pub(crate) struct MaterializeManagerAgentPlanHandoff {
    #[serde(default)]
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub(crate) struct MaterializedManagerAgentPlanHandoff {
    pub(crate) manager_plan: ManagerAgentPlan,
    pub(crate) handoff: AgentHandoffEvent,
    pub(crate) assignment: AgentHandoffAssignment,
}
